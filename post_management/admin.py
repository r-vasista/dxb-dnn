...
class Post_subcat(admin.ModelAdmin):
    list_display=('id','subcat_name','subcat_slug','sub_cat','subcat_status','order','subcat_tag')
...
class VideoPost(admin.ModelAdmin):
    ...
    list_filter=('video_date','video_type','is_active', TopViewedFilter, 'journalist__registration_type', 'author', 'journalist__first_name', 'journalist__organisation_name', 'News_Category','order', 'tags' )
